...
namespace MidasDataAccess.Migrations
{
    ...
    [Migration("20240425073941_addPasswordAdminSeeder")]
    partial class addPasswordAdminSeeder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MidasDataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 25, 14, 39, 40, 161, DateTimeKind.Local).AddTicks(6241),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "445e48a4-f3f6-4660-96d7-82505bc740d3",
                            CreatedAt = new DateTime(2024, 4, 25, 14, 39, 40, 161, DateTimeKind.Local).AddTicks(6349),
                            Name = "Nasabah"
                        });
                });
            ...
            modelBuilder.Entity("MidasDataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 25, 14, 39, 40, 161, DateTimeKind.Local).AddTicks(7065),
                            ...
                            RegistrationDate = new DateTime(2024, 4, 25, 14, 39, 40, 161, DateTimeKind.Local).AddTicks(7048),
