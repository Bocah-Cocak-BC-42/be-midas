...
namespace MidasDataAccess.Migrations
{
    ...
    [Migration("20240426073056_deletePostalCodeTable")]
    partial class deletePostalCodeTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MidasDataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 26, 14, 30, 55, 138, DateTimeKind.Local).AddTicks(4838),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "445e48a4-f3f6-4660-96d7-82505bc740d3",
                            CreatedAt = new DateTime(2024, 4, 26, 14, 30, 55, 138, DateTimeKind.Local).AddTicks(4860),
                            Name = "Nasabah"
                        });
                });
            ...
            modelBuilder.Entity("MidasDataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 26, 14, 30, 55, 138, DateTimeKind.Local).AddTicks(5069),
                            ...
                            RegistrationDate = new DateTime(2024, 4, 26, 14, 30, 55, 138, DateTimeKind.Local).AddTicks(5064),
